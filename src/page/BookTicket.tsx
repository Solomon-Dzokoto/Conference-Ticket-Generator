...
const BookTicket = () => {
    ...
    return (
        <div className="w-[90%] md:w-[80vw] grid gap-4 mx-auto relative z-10  px-4 md:px-0">
            ...
            <h1 className="text-xl md:text-[2rem] font-semibold text-center text-white ">Your Ticket is Booked!</h1>
            <p className="text-sm md:text-base text-center tracking-tighter-2 ">Check your email for a copy or you can <b>download</b> </p>
         
            <div className="w-full md:w-[35vw] mx-auto relative px-3 md:px-6 h-[70vh] md:h-[94vh] grid z-10 place-content-center gap-4  ">
                ...
                <div className="">
                    <img src="/assets/Bar Code.png" alt="barcode" className="w-full relative top-6 p-2 md:p-4 " />
                </div>

            </div>

            <div onClick={()=> navigate("/")} className="flex mt-4 relative z-10 gap-4 flex-col md:flex-row">
                <button  className="w-full transition-colors cursor-pointer p-3 md:p-4 border border-[#24A0B5] bg-[#041E23] text-[#24A0B5] hover:bg-[#24A0B5] hover:text-[#f4f4f4] rounded-md text-sm md:text-base">Book Another Ticket</button>
                <button type="submit" className="w-full p-3 md:p-4 bg-[#24A0B5] border-[#24A0B5] cursor-pointer text-[#f4f4f4] hover:bg-[#041E23] hover:text-[#24A0B5] rounded-md text-sm md:text-base">Download Ticket</button>
            </div>
        </div>
    );
}
